...
let Jlink= document.querySelector("a.category");
let Jdiv=  document.querySelector("div.item");
Jlink.click(function (e) {
    e.preventDefault();
    Jdiv.addClass("d-none");
    Jdiv + this.getAttribute("data-target").removeClass("d-none");
});